...
//about lift motor parameter
const unsigned long moveDuration = 250;  // during 1sec operate (wheel)
const unsigned long liftMoveDuration = 250;  // lift during 0.25sec operate
unsigned long liftMoveStartTime = 0;  // lift motor operation start time save
...
ros::Subscriber<geometry_msgs::Twist> sub_lift("cmd_vel_lift", cmdVelliftCallback);
